    ...
    <div>
        ...
        <el-row v-if="total>0" style="padding-left: 24px; padding-right: 24px;" :gutter="8">
            <el-col :span="6" v-for="course in courses">
                <router-link :to="{ name:'gen_course',params:{courseId:course.courseId}}" replace>
                <el-card class="hj-grid-item" :body-style="{ padding: '0px'}">
                    ...
                    <div style="padding: 14px;font-size: 8px;">
                        ...
                        <div class="bottom" >
                            <el-button type="text" class="button" style="font-size: 8px;">编辑</el-button>
                        </div>
                    </div>
                </el-card>
                </router-link>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getCourse: function () {
                var that = this;
                axios.get(Config.URL_BASE + "/portal/all_course", {
                    params: {
