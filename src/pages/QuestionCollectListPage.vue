            ...
            <el-table :data="pageData" style="width: 100%">
                ...
                <el-table-column
                    ...
                    <template slot-scope="scope">
                        ...
                        <i class="el-icon-delete" @click="deleteQuestion(scope.$index, scope.row)" style="margin-left: 16px;"></i>
                    </template>
                </el-table-column>
            </el-table>
        </el-row>
        ...
        methods: {
            getQuestions: function () {
                ...
                axios.get(Config.URL_BASE + '/question/user', {
                    params: {'action':2,'type': this.questionType, 'page': this.currentPage - 1, 'size': this.pageSize}
